...
public class TaskAdapterReportResult extends RecyclerView.Adapter<TaskAdapterReportResult.MyViewHolder> {
    private List<ModelTaskReportResult> list;
    ...
    public TaskAdapterReportResult(List<ModelTaskReportResult> moviesList) {
        this.list = moviesList;
    }

    @Override
    public TaskAdapterReportResult.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerviewreportresult, parent, false);

        return new TaskAdapterReportResult.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(TaskAdapterReportResult.MyViewHolder holder, int position) {
        ModelTaskReportResult modalTaskMasjid = list.get(position);
