...
public class ModelTaskPengaduan {
    private String nomor, kdUser, kdKamar, kdKeluhan, blokKamar, noKamar, nama, keluhan, tanggalKeluhan, statusKeluhan;

    public ModelTaskPengaduan() {
    }

    public ModelTaskPengaduan(String nomor, String kdUser, String kdKamar, String kdKeluhan, String blokKamar, String noKamar, String nama, String keluhan, String tanggalKeluhan, String statusKeluhan) {
        this.nomor          = nomor;
        this.kdUser         = kdUser;
