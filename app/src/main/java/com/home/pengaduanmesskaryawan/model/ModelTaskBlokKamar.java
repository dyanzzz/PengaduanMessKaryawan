...
public class ModelTaskBlokKamar {

    private String nomor, kdUser, kdKamar, username, blokKamar, noKamar, nama;

    public ModelTaskBlokKamar() {
    }

    public ModelTaskBlokKamar(String nomor, String kdUser, String kdKamar, String username, String blokKamar, String noKamar, String nama) {
        this.nomor      = nomor;
        this.kdUser     = kdUser;
